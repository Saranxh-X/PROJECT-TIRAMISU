...
import { Scale, X, ArrowRight, Trash2, CheckCircle2, MinusCircle, AlertCircle } from "lucide-react";
...
export default function CompareTray() {
  ...
  // Extract unique spec keys across selected products for matrix
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-xs font-bold flex items-center gap-1.5 hover:opacity-90 transition-all shadow-md shadow-indigo-600/30 whitespace-nowrap"
            >
            ...
            <div className="flex items-center justify-between border-b border-slate-800 pb-4 mb-6">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="text-xs text-rose-400 hover:text-rose-300 font-semibold flex items-center gap-1 px-3 py-1.5 rounded-lg bg-rose-500/10 border border-rose-500/20"
                >
